...
```javascript
quaternary3d = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-quaternary3d@v0.2.3-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/array-base-quaternary3d/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/array-base-quaternary3d/actions/workflows/test.yml?query=branch:v0.2.3
